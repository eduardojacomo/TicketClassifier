...
const categorias = ['Question', 'Bug', 'Complaint', 'Login', 'Payment', 'Financial', 'Performance', 'Integration', 'Registration', 'Sales', 'Suggestion', 'Praise', 'Other']
const prioridades = ['Low', 'Medium', 'High', 'Critical']
const departamentos = ['Support', 'Financial', 'Sales', 'Product', 'Development']
const sentimentos = ['positive', 'negative', 'neutral']
...
watch(() => props.ticket, (t) => {
  if (t) {
    form.value = {
      ...
      sentimento: t.sentimento || 'neutral',
